...
3. Open up Crab Game and inject the [1hAck Mod Menu](https://1hack.org/discord/) (v3.2 or higher only)
...
**Btw, anyone who makes at least 1 useful script and shares it on the [discord server](https://1hack.org/discord/) will get the *Script Maker* role ;)**
